...
namespace MonolithEngine
{
  public class AnimationStateMachine : IComponent, IUpdatableComponent, IDrawableComponent
  {
    ...
    private class StateAnimation
    {
      ...
      {
        return obj is AnimationStateMachine.StateAnimation stateAnimation && this.state == stateAnimation.state && EqualityComparer<Func<bool>>.Default.Equals(this.function, stateAnimation.function) && EqualityComparer<AbstractAnimation>.Default.Equals(this.animation, stateAnimation.animation) && this.priority == stateAnimation.priority;
      }
