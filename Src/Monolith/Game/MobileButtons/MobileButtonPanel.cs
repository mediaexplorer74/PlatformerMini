...
namespace ForestPlatformerExample
{
  internal class MobileButtonPanel
  {
    ...
    {
      SelectableImage selectableImage1 = new SelectableImage(Assets.GetTexture2D("LeftArrow"), position: new Vector2(25f, 550f), scale: 9f, fireOnHold: true);
      ...
      this.buttons.Add(new SelectableImage(Assets.GetTexture2D("DownArrow"), position: new Vector2(265f, 550f), scale: 9f, fireOnHold: true)
      {
      ...
      this.buttons.Add(new SelectableImage(Assets.GetTexture2D("UpArrow"), position: new Vector2(265f, 450f), scale: 9f, fireOnHold: true)
      {
        OnClick = this.AddButtonAction(hero, new Action(hero.ClimbUpOnLadder))
      });
      SelectableImage selectableImage2 = new SelectableImage(Assets.GetTexture2D("RightArrow"), position: new Vector2(150f, 550f), scale: 9f, fireOnHold: true);
      ...
      this.buttons.Add(new SelectableImage(Assets.GetTexture2D("SquareButton"), position: new Vector2(1050f, 550f), scale: 9f)
      {
        OnClick = this.AddButtonAction(hero, new Action(hero.AttackOrThrow))
      });
      this.buttons.Add(new SelectableImage(Assets.GetTexture2D("XButton"), position: new Vector2(1200f, 550f), scale: 9f)
      {
        OnClick = this.AddButtonAction(hero, new Action(hero.Jump))
      });
      this.buttons.Add(new SelectableImage(Assets.GetTexture2D("TriangleButton"), position: new Vector2(1125f, 450f), scale: 9f)
      {
        OnClick = this.AddButtonAction(hero, new Action(hero.InteractWithItem))
      });
      this.buttons.Add(new SelectableImage(Assets.GetTexture2D("CircleButton"), position: new Vector2(1275f, 450f), scale: 9f)
      {
