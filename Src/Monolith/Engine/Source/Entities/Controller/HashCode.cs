...
namespace MonolithEngine//System
{
...
#pragma warning restore 0809
    ...
    {
        internal static ref byte Add(ref byte pos, object length)
        {
            throw new NotImplementedException();
        }
    }

    internal class MemoryMarshal
    {
        internal static ref byte GetReference(ReadOnlySpan<byte> value)
        {
            throw new NotImplementedException();
        }
    }
