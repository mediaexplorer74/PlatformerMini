...
namespace MonolithEngine
{
  public class Line : Entity
  {
    ...
    {
      spriteBatch.Draw(this.GetComponent<Sprite>().Texture.GetTexture2D(), 
          this.Transform.Position, new Rectangle?(), this.color, this.angleRad, 
          this.Origin, this.Scale, SpriteEffects.None, 0.0f);
    }
